...
(function () {
  ...
  if (typeof revenueGrowthChartEl !== undefined && revenueGrowthChartEl !== null) {
    ...
    // Revenue Growth - Bar Chart
  // --------------------------------------------------------------------
  const revenueGrowthCharttEl = document.querySelector('#revenueGrowthChartt'),
    revenueGrowthCharttConfig = {
      chart: {
        height: 87,
        type: 'bar',
        stacked: true,
  ...
  if (typeof revenueGrowthCharttEl !== undefined && revenueGrowthCharttEl !== null) {
    const revenueGrowthChartt = new ApexCharts(revenueGrowthCharttEl, revenueGrowthCharttConfig);
    revenueGrowthChartt.render();
  }
