...
(function () {
  ...
  if (dragMapVar) {
    // const draggableMap = L.map('dragMap').setView([19.047, 73.0083, 2.455], 12);
    const markerLocation = L.marker([19.047, 73.0083, 2.455], {
      draggable: 'true'
    }).addTo(draggableMap);
    markerLocation.bindPopup("<b>MUMBAI</b>").openPopup();
        L.tileLayer('https://{s}.tile.osm.org/{z}/{x}/{y}.png', {
          attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>',
          maxZoom: 18
        }).addTo(draggableMap);
